...
import panesSchema from './panesSchema';
...
class PenelExample extends Component {
  ...
  onSubmit(questionAnswers, target) {
    ...
    console.log(
      'purged answers:',
      Winterfell.purgeQuestionAnswers(panesSchema.questionSets[0].questions, questionAnswers)
    );
  }
    ...
    return (
      <div className="panel-example">
        <ul id="questions-pane" className="nav nav-tabs" onClick={this.onClickPanel}>
          <li role="presentation" className={this.isActive('questions-1')}>
            <a data-pane="questions-1" href="#">
              Questions #1
            </a>
          </li>
          <li role="presentation" className={this.isActive('questions-2')}>
            <a data-pane="questions-2" href="#">
              Questions #2
            </a>
          </li>
          <li role="presentation" className={this.isActive('questions-3')}>
            <a data-pane="questions-3" href="#">
              Questions #3
            </a>
          </li>
        </ul>
